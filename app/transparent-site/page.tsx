      ...
      <section className="section bg-white">
        <div className="container-page">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-4 section-title">透明工地到底留下哪些记录</h2>
            <p className="section-subtitle">
              它不能承诺“没有问题”，但能让问题、进度和确认事项尽量有记录可查。
            </p>
          </div>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {evidenceItems.map(([title, desc]) => (
              <div key={title} className="rounded-2xl border border-forest/10 bg-cream-50 p-5">
      ...
      <section className="section bg-forest-50">
        <div className="container-page">
          ...
          <p className="mt-8 text-center text-[11px] text-ink-muted">
            以上为模拟界面，实际以{siteConfig.miniProgram.name}为准。具体记录范围以项目实际开通功能和合同约定为准。
          </p>
        </div>
      </section>
